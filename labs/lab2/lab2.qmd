...
The 7-segment display and Green LEDS have a forward voltage of roughly 2.0 V, and we do not want to exceed the FPGA GPIO current of 8 mA. So, we can use Ohm's kaw to find the desired resistor (using a current of 5 mA) This is shown in @eq-leds:
