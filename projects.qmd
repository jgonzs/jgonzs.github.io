...
<div id="moreContentEV" style="display:none;">
  <div class="row">
    <div class="column">
      ...
      <img src="https://placehold.co/400x300?text=EV+Background" alt="EV Background" style="width:100%; border-radius: 15px;">
      <div style="padding: 5px; font-size: 0.8rem;">- Coming soon.</div>
    </div>
    <div class="column">
      <strong>Methods</strong>
      <img src="https://placehold.co/400x300?text=EV+Methods" alt="EV Methods" style="width:100%; border-radius: 15px;">
      <div style="padding: 5px; font-size: 0.8rem;">- Coming soon.</div>
    </div>
    <div class="column">
      <strong>Result</strong>
      <img src="https://placehold.co/400x300?text=EV+Result" alt="EV Result" style="width:100%; border-radius: 15px;">
      <div style="padding: 5px; font-size: 0.8rem;">- Coming soon.</div>
    </div>
  </div>
</div>
...
<div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 20px; margin-bottom: 1em;">
  <div style="flex: 2; width: 300px;">
    <img src="images/e80Robot.png" alt="E80 Robot" style="width:100%; border-radius: 15px;">
  </div>
  <div style="flex: 2; min-width: 300px;">
    <p class="justify-text">
      <strong>Overview:</strong><br>
      Designed and created an Autonomous Underwater Vehicle (AUV) to create topography maps of the harbor floor using Time-of-flight measurements via SONAR technology (10W Exciter &amp; Electret Mic).
    </p>
    <p><strong>Skills:</strong><br>Arduino, MATLAB, SONAR, Embedded Systems, PCB Assembly</p>
...
<div id="moreContentAUV" style="display:none;">
  <div class="row">
    <div class="column">
      <strong>Background</strong>
      <img src="https://placehold.co/400x300?text=AUV+Background" alt="AUV Background" style="width:100%; border-radius: 15px;">
      <div style="padding: 5px; font-size: 0.8rem;">
        - Created an AUV to map harbor floor topography.<br><br>
        - Used Time-of-Flight SONAR measurements to generate depth data.
      </div>
    </div>
    <div class="column">
      <strong>Methods</strong>
      <img src="https://placehold.co/400x300?text=AUV+Methods" alt="AUV Methods" style="width:100%; border-radius: 15px;">
      <div style="padding: 5px; font-size: 0.8rem;">
        - Integrated SONAR transducer and microphone into waterproofed AUV housing.<br><br>
        - Programmed microcontroller to record time-of-flight signals and log depth measurements.
      </div>
    </div>
    <div class="column">
      <strong>Result</strong>
      <img src="https://placehold.co/400x300?text=AUV+Result" alt="AUV Result" style="width:100%; border-radius: 15px;">
      <div style="padding: 5px; font-size: 0.8rem;">
        - Successfully generated topography maps of the harbor floor.<br><br>
        - Validated low-cost SONAR-based AUV design for real-world underwater mapping.
      </div>
    </div>
  </div>
</div>
